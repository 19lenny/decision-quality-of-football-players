...
for event in matchIdEM2020:
    ...
    dfShotEM2020 = pd.concat([dfShotEM2020, get_all_events_of_this_match])
    counter += 1
    print("nothing to worry - still working")
    print("progress bar to get all events at EM20: ", counter, " / ", len(matchIdEM2020))
...
dfEM2020.reset_index(drop=True, inplace=True)
...
dfEM2020 = model_info.prediction(dfEM2020)

# add the current score of this competition
dfEM2020 = DataManipulation.score(dfEM2020)
print("score is done")
...
dfEM2020, attributes_added_TM = TM_values.transfermarketValue(dfCompetition=dfEM2020, competition="EM20")
...
dfEM2020, attributes_added_xG = evaluate_decision.decisionEvaluation(dfEM2020, "EM20")
