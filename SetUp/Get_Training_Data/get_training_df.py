...
def get_training_df():
    ...
    #add delta Goalkeeper to optimal line
    dfModelData = DataManipulation.addDeltaGKToOptimalLine(dfModelData)
    ...
    dfModelData = dfModelData[
        ["x_coordinate", "y_coordinate", "shot_end_location", "shot_outcome", "goal", "angleDeg", "angleInRadian", "log_angle", "distance_to_goal_centre",
         "shot_statsbomb_xg", "shot_body_part", "period",
         "minute", "shot_type", "match_date", "competition",
         "season", "home_team", "away_team", "home_score", "away_score", "competition_stage", "match_id", "competition_id", "season_id", "shot_freeze_frame",
         "delta_distance_GK_to_optimal_line"]]
