...
ax.plot(shot_x, shot_y, 'o', color='red', label=f"striker: Vinicius Junior: ({shot_x}, {shot_y})")
ax.plot(x_GK, y_GK, 'o', color='blue', label=f"goalkeeper: Yann Sommer: ({x_GK}, {y_GK})")
...
ax.plot([x_GK, x_intersection], [y_GK, y_intersection], linestyle='--', color='blue', label="distance GK to optimal line")
